...
if (count($data) == 0) {
    $listOptions['prompt'] = Yii::t('entero:web', 'Select...', ['category' => $model->category]);
}
    ...
    'addon' => [
        'append' => [
            ...
            'content' => Html::button(
                    ...
                    ['title' => Yii::t('entero:web', 'Save'), 'class' => "dynagrid-detail-save btn btn-primary"]
                ) .
                Html::button(
                    '<span class="glyphicon glyphicon-remove"></span>',
                    ['title' => Yii::t('entero:web', 'Delete'), 'class' => "dynagrid-detail-delete btn btn-danger"]
                )
        ]
    ]
