...
use codexten\yii\web\widgets\importer\components\StandardModel as BaseStandardModel;
    ...
    public function parseAttributeNames($row)
    {
        ...
        foreach ($row->getCellIterator() as $cell) {
            ...
            if (!in_array($cell->getValue(), $standardAttributeNames)) {
                ...
                Importer::addError(1, ['Attribute not exist. please check attribute name'], $cell->getValue());
