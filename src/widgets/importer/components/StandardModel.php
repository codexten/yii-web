...
namespace codexten\yii\web\widgets\importer\components;
...
class StandardModel extends Object
{
     ...
     * @var string
     */
    protected static $standardAttributeClassName = 'codexten\yii\web\widgets\importer\components\StandardAttribute';
